...
namespace GOOS_SampleTests.Controllers
{
    ...
    public class BudgetServiceTests
    {
        ...
        {
            SetupMock("2018-04", "2018-05", new List<BudgetEntity>
            {
        ...
        private void SetupMock(string start, string end, List<BudgetEntity> entities)
        {
            _repository.GetList(start, end).Returns(entities);
        }
        ...
        public void test_Get_Average_Budget_between_20180415_and_20180630_should_return_940()
        {
            ...
            SetupMock("2018-04", "2018-06", new List<BudgetEntity>
            {
                new BudgetEntity {YearMonth = "2018-04", Amount = 600},
                new BudgetEntity {YearMonth = "2018-05", Amount = 620}
            });
        ...
        {
            SetupMock("2018-05", "2018-07", new List<BudgetEntity>
            {
                new BudgetEntity{ YearMonth = "2018-05", Amount = 620},
        ...
        {
            SetupMock("2016-01", "2016-02", new List<BudgetEntity>
            {
